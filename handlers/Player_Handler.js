          ...
          embeds: [
            new MessageEmbed()
              ...
              .addFields([
                ...
                {
                name: `**Download:**`,
                value: `[Download Song](${song.streamURL})`,
                inline: true,
              },
              ])
          ...
          embeds: [
            new MessageEmbed()
              ...
              .addFields([
                ...
                {
                  name: `Message Delete`,
                  value: `<a:10sp:961858415926333470>`,
                  inline: true,
                },
              ])
              .setFooter({ text: ee.footertext, iconURL: ee.footericon }),
      ...
      queue.textChannel.send({
        embeds: [
          new MessageEmbed()
            .setColor(ee.color)
            .setDescription(
              ` Queue has ended! No more music to play... \n Enjoying  music with me? Consider joining my [discord](https://discord.gg/UP9dyKMttc)`
            )
            .setFooter({ text: ee.footertext, iconURL: ee.footericon }),
        ],
      });
          ...
          case "pause":
            {
              if (!channel) {
                ...
                client.buttons.components[1] = new MessageButton()
                  ...
                  .setStyle("SECONDARY")
                  //.setLabel("")
                  .setEmoji(`<:pause:967471320239583242>`); //song pause
                let ID =
                ...
                client.buttons.components[1] = new MessageButton()
                  ...
                  .setStyle("SECONDARY")
                  //.setLabel("")
                  .setEmoji("<:resume:967472729764798564>"); //song resume
                let ID =
                  client.temp.get(queue.textChannel.guild.id) ||
                  client.temp2.get(queue.textChannel.guild.id);
                let playembed = await queue.textChannel.messages
          ...
          case "loop":
            {
              if (!channel) {
                ...
                client.buttons.components[3] = new MessageButton()
                  ...
                  .setCustomId("loop")
                  //.setLabel("")
                  .setEmoji("<:trackloop:967473207974199366>");  //queue track loop
                  let ID =
                  client.temp.get(queue.textChannel.guild.id) ||
                  client.temp2.get(queue.textChannel.guild.id);
                let playembed = await queue.textChannel.messages
                ...
                client.buttons.components[3] = new MessageButton()
                  ...
                  .setCustomId("loop")
                  //.setLabel("")
                  .setEmoji("<:off:967473207877705728>"); //off
                  let ID =
                  client.temp.get(queue.textChannel.guild.id) ||
                  client.temp2.get(queue.textChannel.guild.id);
                let playembed = await queue.textChannel.messages
                ...
                client.buttons.components[3] = new MessageButton()
                  ...
                  .setCustomId("loop")
                  //.setLabel("")
                  .setEmoji("<:songloop:967471320193458236>"); //song loop
                  let ID =
                  client.temp.get(queue.textChannel.guild.id) ||
                  client.temp2.get(queue.textChannel.guild.id);
                let playembed = await queue.textChannel.messages
